...
var _preview = __webpack_require__(60);
...
var _reactLowlight = __webpack_require__(9);
...
var _iconContentCopy = __webpack_require__(66);

var _iconContentCopy2 = _interopRequireDefault(_iconContentCopy);

var _iconClose = __webpack_require__(67);

var _iconClose2 = _interopRequireDefault(_iconClose);

var _reactStatic = __webpack_require__(2);

var _reactOver = __webpack_require__(68);
...
var _reactOverAnimations = __webpack_require__(87);
    ...
    value: function render() {
      ...
      var filteredCategories = _lodash2.default.mapValues(_iconsData2.default.categories, function (categoryIcons, categoryName) {
        return categoryIcons.filter(function (icon) {
          ...
          return icon.iconName.toLowerCase().includes(lowercaseQuery) || icon.iconClass.toLowerCase().includes(lowercaseQuery) || categoryName.toLowerCase().includes(lowercaseQuery);
        });
      });
      ...
      var displayDeleteIcon = Boolean(search);
          ...
          function (_ref2) {
            ...
            return _react2.default.createElement(
              ...
              _react2.default.createElement(
                ...
                _react2.default.createElement(
                  'div',
                  { className: 'iconCatalog_searchContainer' },
...
var _javascript = __webpack_require__(40);
...
var _reactStaticRoutes = __webpack_require__(47);

var _reactStaticRoutes2 = _interopRequireDefault(_reactStaticRoutes);

var _noScroll = __webpack_require__(21);
...
var _historyWithQuery = __webpack_require__(106);
...
var _importCss2 = __webpack_require__(49);

var _importCss3 = _interopRequireDefault(_importCss2);

var _universalImport2 = __webpack_require__(50);
...
var t_5 = (0, _reactUniversalComponent2.default)((0, _universalImport3.default)({
  ...
  file: '/Users/jamess/webdev/react-projects/materialish/docs/dist/react-static-routes.js',
  load: function load() {
    return Promise.all([new Promise(function(resolve) { resolve(); }).then(__webpack_require__.bind(null, 22)), (0, _importCss3.default)('src/icons/usage', {
      disableWarnings: true
    })]).then(function (proms) {
      return proms[0];
    });
...
var t_6 = (0, _reactUniversalComponent2.default)((0, _universalImport3.default)({
  ...
  file: '/Users/jamess/webdev/react-projects/materialish/docs/dist/react-static-routes.js',
  load: function load() {
    return Promise.all([new Promise(function(resolve) { resolve(); }).then(__webpack_require__.bind(null, 23)), (0, _importCss3.default)('src/components/index', {
      disableWarnings: true
    })]).then(function (proms) {
      return proms[0];
    });
...
var t_7 = (0, _reactUniversalComponent2.default)((0, _universalImport3.default)({
  ...
  file: '/Users/jamess/webdev/react-projects/materialish/docs/dist/react-static-routes.js',
  load: function load() {
    return Promise.all([new Promise(function(resolve) { resolve(); }).then(__webpack_require__.bind(null, 24)), (0, _importCss3.default)('src/components/component-doc', {
      disableWarnings: true
    })]).then(function (proms) {
      return proms[0];
    });
...
var t_8 = (0, _reactUniversalComponent2.default)((0, _universalImport3.default)({
  ...
  file: '/Users/jamess/webdev/react-projects/materialish/docs/dist/react-static-routes.js',
  load: function load() {
    return Promise.all([new Promise(function(resolve) { resolve(); }).then(__webpack_require__.bind(null, 25)), (0, _importCss3.default)('src/components/text-fields', {
      disableWarnings: true
    })]).then(function (proms) {
      return proms[0];
    });
...
var t_9 = (0, _reactUniversalComponent2.default)((0, _universalImport3.default)({
  ...
  file: '/Users/jamess/webdev/react-projects/materialish/docs/dist/react-static-routes.js',
  load: function load() {
    return Promise.all([new Promise(function(resolve) { resolve(); }).then(__webpack_require__.bind(null, 26)), (0, _importCss3.default)('src/components/progress-indicators', {
      disableWarnings: true
    })]).then(function (proms) {
      return proms[0];
    });
...
var t_10 = (0, _reactUniversalComponent2.default)((0, _universalImport3.default)({
  ...
  file: '/Users/jamess/webdev/react-projects/materialish/docs/dist/react-static-routes.js',
  load: function load() {
    return Promise.all([new Promise(function(resolve) { resolve(); }).then(__webpack_require__.bind(null, 27)), (0, _importCss3.default)('src/components/selection-controls', {
      disableWarnings: true
    })]).then(function (proms) {
      return proms[0];
    });
...
var t_11 = (0, _reactUniversalComponent2.default)((0, _universalImport3.default)({
  ...
  file: '/Users/jamess/webdev/react-projects/materialish/docs/dist/react-static-routes.js',
  load: function load() {
    return Promise.all([new Promise(function(resolve) { resolve(); }).then(__webpack_require__.bind(null, 28)), (0, _importCss3.default)('src/components/buttons', {
      disableWarnings: true
    })]).then(function (proms) {
      return proms[0];
    });
...
var t_12 = (0, _reactUniversalComponent2.default)((0, _universalImport3.default)({
  ...
  file: '/Users/jamess/webdev/react-projects/materialish/docs/dist/react-static-routes.js',
  load: function load() {
    return Promise.all([new Promise(function(resolve) { resolve(); }).then(__webpack_require__.bind(null, 29)), (0, _importCss3.default)('src/components/chips', {
      disableWarnings: true
    })]).then(function (proms) {
      return proms[0];
    });
...
var t_13 = (0, _reactUniversalComponent2.default)((0, _universalImport3.default)({
  ...
  file: '/Users/jamess/webdev/react-projects/materialish/docs/dist/react-static-routes.js',
  load: function load() {
    return Promise.all([new Promise(function(resolve) { resolve(); }).then(__webpack_require__.bind(null, 30)), (0, _importCss3.default)('src/common/404', {
      disableWarnings: true
    })]).then(function (proms) {
      return proms[0];
    });
...
var _standalone = __webpack_require__(61);
...
module.exports = require("materialish/icon-close");
...
var _reactTransitionGroupPlus = __webpack_require__(69);
...
var _overWrapper = __webpack_require__(71);

var _overWrapper2 = _interopRequireDefault(_overWrapper);

var _isValidTriggerElement = __webpack_require__(85);

var _isValidTriggerElement2 = _interopRequireDefault(_isValidTriggerElement);

var _validateOverConfig = __webpack_require__(86);
...
var _computePosition = __webpack_require__(72);

var _computePosition2 = _interopRequireDefault(_computePosition);

var _getStyles = __webpack_require__(82);

var _getStyles2 = _interopRequireDefault(_getStyles);

var _simpleShallowEquals = __webpack_require__(84);
...
var _identification = __webpack_require__(83);
...
// module
exports.push([module.i, ".iconCatalog_searchContainer{margin-bottom:10px;display:inline-block;position:relative}.iconsCatalog_clearSearchIcon{position:absolute;top:50%;-webkit-transform:translateY(-50%);-ms-transform:translateY(-50%);transform:translateY(-50%);right:.625rem;fill:#999;cursor:pointer;will-change:opacity;opacity:1;-webkit-transition:opacity .25s ease-in-out;-o-transition:opacity .25s ease-in-out;transition:opacity .25s ease-in-out;outline:none;border:2px solid transparent;border-radius:3px;-webkit-box-sizing:border-box;box-sizing:border-box}.iconsCatalog_clearSearchIcon.focus-visible{border-color:var(--mainColor)}.iconsCatalog_clearSearchIcon-enter,.iconsCatalog_clearSearchIcon-exit-active{opacity:0}.iconsCatalog_clearSearchIcon-enter-active{opacity:1}.iconsCatalog_searchInput{padding:10px 15px;padding-right:2.6rem;width:350px;border:1px solid #ddd;border-radius:3px;font-family:Roboto;font-size:1rem;outline:none}.iconsCatalog_primaryHeader{margin-bottom:0}.iconsCatalog_heading{position:-webkit-sticky;position:sticky;z-index:1;top:var(--headerHeight);background:#fff;padding:40px 0;border-bottom:1px solid #ddd}.iconsCatalog_count{margin-bottom:0}.iconsCatalog_searchInput:focus{border:1px solid var(--mainColor)}.iconsCatalog_icon{display:-ms-flexbox;display:flex;-ms-flex-direction:column;flex-direction:column;-ms-flex-align:center;align-items:center;z-index:0;position:relative;border-radius:5px;padding:15px;cursor:pointer;border:1px solid transparent;-webkit-transition:-webkit-box-shadow .2s;transition:-webkit-box-shadow .2s;-o-transition:box-shadow .2s;transition:box-shadow .2s;transition:box-shadow .2s,-webkit-box-shadow .2s}.iconsCatalog_icon:hover{-webkit-box-shadow:0 1px 3px rgba(0,0,0,.25);box-shadow:0 1px 3px rgba(0,0,0,.25)}.iconsCatalog_icon>svg,.iconsCatalog_iconDetails>svg{margin-bottom:10px}.iconsCatalog_iconList{display:grid;grid-column-gap:20px;grid-row-gap:50px;grid-template-columns:repeat(auto-fill,minmax(150px,1fr));padding:0 5px}.iconsCatalog_iconClass{display:block;text-align:center;width:100%;font-size:.75rem;overflow:hidden;-o-text-overflow:ellipsis;text-overflow:ellipsis;white-space:nowrap}.iconsCatalog_category{border-bottom:1px solid #ddd;padding-bottom:50px;margin-bottom:50px}.iconsCatalog_category:first-child{padding-top:40px}.iconsCategory_categoryHeader{color:var(--mainColor);font-size:1rem;font-weight:500}.iconsCatalog_iconDetails{background:#fff;border-radius:3px;min-width:400px;padding:15px;text-align:center;display:-ms-flexbox;display:flex;-ms-flex-direction:column;flex-direction:column;-ms-flex-align:center;align-items:center}.iconsCatalog_detailsImport{margin-top:15px;background-color:#fafafa;border-radius:3px}.iconsCatalog_importStatement{font-size:.85rem;padding:10px 8px}.iconsCatalog_copyImportBtn{display:inline-block;border:1px solid transparent;border-radius:0 3px 3px 0;background-color:transparent;border-left:1px solid #eee;fill:var(--mainColor);padding:10px 8px;width:40px;outline:none}.iconsCatalog_copyImportBtn:hover{background-color:#efedfb}.iconsCatalog_copyImportBtn.focus-visible{border:1px solid var(--mainColor)}.iconsCatalog_iconDetailsName{font-size:1.2rem;font-weight:500}@media (max-width:650px){.iconsCatalog_searchInput{width:100%}.iconsCatalog_count{text-align:center}.iconsCatalog_heading{padding:20px 0}}", ""]);
...
var _materialishLogo = __webpack_require__(97);
...
var _iconKeyboardArrowRight = __webpack_require__(100);
...
//# sourceMappingURL=static.0d0e59ca.js.map